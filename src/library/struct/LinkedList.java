...
public class LinkedList<AnyType> extends AbstractCollection<AnyType> implements List<AnyType>, Queue<AnyType> {
  ...
  /**
   * Returns the position of first item matching x in this collection, or NOT_FOUND if not found.
   * 
   * @param x any object.
   ...
   * @param idx the index to start the iterator. Use size() to do complete reverse traversal. Use 0 to do complete forward traversal.
   * @throws IndexOutOfBoundsException if idx is not between 0 and size(), inclusive.
   */
  ...
  /**
   * This is the implementation of the LinkedListIterator. It maintains a notion of a current position and of course the implicit reference to the LinkedList.
   */
