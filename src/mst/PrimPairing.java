...
public class PrimPairing {
  ...
  public PrimPairing(MstGraph graph) {
    this.graph = graph;
    this.cost = 0;
  }
  ...
  public static void main(String[] args) throws Exception {
    ...
    PrimPairing prim = new PrimPairing(g);
   ...
   */
  public static boolean processRequest(PrimPairing prim) throws IOException {
