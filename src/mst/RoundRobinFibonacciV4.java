...
public class RoundRobinFibonacciV4 {
  ...
  public class RoundRobinStruct {
    ...
    private FibonacciHeap<PairVertex<Integer>> pq;
    ...
    public RoundRobinStruct() {
      pq = new FibonacciHeap<PairVertex<Integer>>();
    }
  }
  ...
  public RoundRobinFibonacciV4(UndirectedGraph<Integer> graph) throws Exception {
    this.graph = graph;
  }
  ...
  private void makeEdgesFrom(FibonacciHeap<PairVertex<Integer>> heap, int node) {
