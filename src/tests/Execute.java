...
public class Execute {
  ...
  public static void main(String[] args) throws Exception {
    ...
    UndirectedGraph<Integer> stringGraph2 = Utils.getUndirectedFromInputFile("data/ALUE/alue2087_teste.stp"); //new UndirectedGraph<String>();
    ...
    System.out.println();
    mst.PrimFibonacci<Integer> teste3 = new mst.PrimFibonacci<Integer>(stringGraph2);
    teste3.generateMST();
