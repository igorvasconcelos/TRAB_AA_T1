...
/*
 * mst.Prim<Integer> teste = new Prim<Integer>(intGraph); teste.generateMST(); System.out.println("Nó inicial: " + teste.getStartNode()); for
 * (PairVertex<Integer> node : teste.getSpanningTree()) { System.out.println(node.getOne() + " - " + node.getTwo() + " : " + node.getCost()); }
...
/*
 * System.out.println(); mst.Prim<String> teste3 = new mst.Prim<String>(stringGraph2); teste3.generateMST(); System.out.println("Nó inicial: " +
 * teste3.getStartNode()); for (PairVertex<String> parVetex : teste3.getSpanningTree()) { System.out.println(parVetex.getOne() + " - " + parVetex.getTwo() +
