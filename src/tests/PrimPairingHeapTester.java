...
import mst.PrimPairing;

public class PrimPairingHeapTester {
  ...
  public static void main(String[] args) throws Exception {
    ...
    new PrimPairingHeapTester().run(args.length == 2); //args.length == 2
  }
  ...
  protected void genericProcess(MstGraph graph) {
    try {
      ...
      PrimPairing primLeftist = new PrimPairing(graph);
