...
/*
 * AVL<String> t = new AVL<String>(); AVL.Elem<String> elem; System.out.println("Escolhido n� A"); t.put("B", 8); t.printBST(); t.put("C", 5); t.printBST();
 * System.out.println("Escolhido n� " + t.removeMin().getValue()); t.printBST(); t.put("D", 3); t.printBST(); t.put("F", 16); t.printBST();
 * System.out.println("Escolhido n� " + t.removeMin().getValue()); t.printBST(); t.put("E", 12); t.printBST(); t.put("G", 14); t.printBST(); elem = new
 * AVL.Elem<String>("B", 8); t.remove( elem ); t.printBST(); t.put("B", 2); t.printBST(); System.out.println("Escolhido n� " + t.removeMin().getValue());
 * t.printBST(); System.out.println("Escolhido n� " + t.removeMin().getValue()); t.printBST(); elem = new AVL.Elem<String>("G", 14); t.remove( elem );
 * t.printBST(); t.put("G", 4); t.printBST(); System.out.println("Escolhido n� " + t.removeMin().getValue()); t.printBST(); System.out.println("Escolhido n� " +
 * t.removeMin().getValue()); t.printBST(); System.out.println("Arvore Geradora Minima Pronta");
 */
    ...
    System.out.println();
    mst.PrimTree teste4 = new mst.PrimTree(intGraph);
    teste4.generateMST();
    ...
    System.out.println();
    mst.PrimTree teste = new mst.PrimTree(intGraph);
    teste.generateMST();
    System.out.println("N� inicial: " + teste.getStartNode());
    for (PairVertex<Integer> parVetex : teste.getSpanningTree()) {
      System.out.println(parVetex.getOne() + " - " + parVetex.getTwo() + " : " + parVetex.getCost());
    }
